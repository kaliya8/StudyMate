...
import pages.ACoursesPageClass;
import pages.AStudyMateLoginPageClass;
import pages.AStudyMateMainPageClass;
...
public class AAssignTeacher_steps {
    AStudyMateLoginPageClass studyMateLoginPageClass = new AStudyMateLoginPageClass();
    AStudyMateMainPageClass studyMateMainPageClass = new AStudyMateMainPageClass();
    ACoursesPageClass coursesPageClass = new ACoursesPageClass();
